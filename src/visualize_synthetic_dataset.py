...
def main():
    ...
    parser.add_argument("--input_dir", type=str, default="./datasets/synthetic_uav_148_bs23_beam14_snr25.0_std10.0_scatterers1_windowFalse_w10h10_correct-label", help="Path to the directory containing the dataset")
    ...
    parser.add_argument("--collection_name", type=str, default="traj_2", help="Name of the collection to visualize")
